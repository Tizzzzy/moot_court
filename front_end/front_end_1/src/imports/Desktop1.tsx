import svgPaths from "./svg-xci9x66byb";
  ...
  return (
    <div className="flex-[1_0_0] h-[20px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#08f] text-[14px] top-[0.5px] tracking-[-0.1504px]">1. Case Status</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="flex-[1_0_0] h-[20px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#757575] text-[14px] top-[0.5px] tracking-[-0.1504px]">2. Entry Method</p>
      </div>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="flex-[1_0_0] h-[20px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#757575] text-[14px] top-[0.5px] tracking-[-0.1504px]">3. Case Details</p>
      </div>
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="h-[32px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[32px] left-0 not-italic text-[#1e1e1e] text-[24px] top-0 tracking-[0.0703px]">{`What's your case status?`}</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#1e1e1e] text-[16px] top-[-0.5px] tracking-[-0.3125px]">This helps us understand where you are in the process</p>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="absolute h-[28px] left-0 top-0 w-[232.906px]" data-name="Heading 3">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-0 not-italic text-[#1e1e1e] text-[20px] top-0 tracking-[-0.4492px]">Officially Filed</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="absolute h-[20px] left-0 top-[36px] w-[232.906px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#1e1e1e] text-[14px] top-[0.5px] tracking-[-0.1504px]">I have a case number from the court</p>
    </div>
  );
}
...
function Badge() {
  return (
    <div className="absolute bg-[#dcfce7] border border-[rgba(0,0,0,0)] border-solid h-[22px] left-0 overflow-clip rounded-[8px] top-[70.5px] w-[101.727px]" data-name="Badge">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[8px] not-italic text-[#34c759] text-[12px] top-[3px]">Most Common</p>
    </div>
  );
}
...
function Container9() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-start min-h-px min-w-px pb-[24px] relative w-full" data-name="Container">
      <Container10 />
      <Container11 />
    </div>
  );
...
function Button() {
  return (
    <div className="flex-[1_0_0] h-[144px] min-h-px min-w-px relative rounded-[10px]" data-name="Button">
...
function Heading3() {
  return (
    <div className="h-[28px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-0 not-italic text-[#1e1e1e] text-[20px] top-0 tracking-[-0.4492px]">Submitted/Pending</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#1e1e1e] text-[14px] top-[0.5px] tracking-[-0.1504px]">Waiting for court approval</p>
    </div>
  );
}
...
export default function Desktop() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex flex-col gap-[32px] items-center relative size-full" data-name="Desktop - 1">
      <GlobalHeader />
      <CaseIntake />
    </div>
  );
