import svgPaths from "./svg-5eyf1icmi4";
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p269bac80} id="Vector" stroke="var(--stroke-0, #E17100)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
...
function Paragraph() {
  return (
    <div className="h-[24px] relative shrink-0 w-[149px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#7b3306] text-[16px] top-[-0.5px] tracking-[-0.3125px] w-[159px] whitespace-pre-wrap">Objection: Hearsay</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex gap-[8px] items-start left-1/2 top-[1052px] w-[180px]">
      <Icon2 />
      <Paragraph />
    </div>
  );
...
function Container11() {
  return (
    <div className="absolute h-[144px] left-0 top-[1082px] w-[672px]" data-name="Container">
      <Badge3 />
      <Card4 />
    </div>
  );
...
function Heading() {
  return (
    <div className="absolute h-[24px] left-[28px] top-0 w-[137.531px]" data-name="Heading 3">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#0f172b] text-[16px] top-[-0.5px] tracking-[-0.3125px]">Tips for answering objection:</p>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="absolute h-[24px] left-[16px] top-[16px] w-[800px]" data-name="Container">
      <Icon3 />
      <Heading />
    </div>
  );
...
function List() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[76px] items-start left-[44px] top-[52px] w-[772px]" data-name="List">
      <ListItem />
      <ListItem1 />
      <ListItem2 />
    </div>
...
function Container12() {
  return (
    <div className="absolute bg-[#eff6ff] border border-[#bedbff] border-solid h-[146px] left-0 rounded-[10px] top-[1273px] w-[896px]" data-name="Container">
      <Container13 />
      <List />
    </div>
  );
...
export default function Desktop() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex flex-col gap-[32px] items-center relative size-full" data-name="Desktop - 19">
      <GlobalHeader />
      <Container4 />
      <Frame />
      <Container14 />
