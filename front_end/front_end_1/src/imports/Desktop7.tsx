import svgPaths from "./svg-o3j2m9cf5w";
...
function Text1() {
  return (
    <div className="h-[24px] relative shrink-0 w-[362.469px]" data-name="Text">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-0 not-italic text-[#45556c] text-[16px] top-[-0.5px] tracking-[-0.3125px]">
        <span className="font-['Inter:Bold',sans-serif] font-bold leading-[24px]">1</span>
        <span className="leading-[24px]">{` of 4 categories have evidence • `}</span>
        <span className="font-['Inter:Bold',sans-serif] font-bold leading-[24px]">1</span>
...
function PrimitiveDiv() {
  return (
    <div className="bg-[rgba(3,2,19,0.2)] col-1 content-stretch flex flex-col items-start ml-0 mt-0 overflow-clip pl-[-763.328px] pr-[763.328px] relative rounded-[16777200px] row-1 w-[763.328px]" data-name="Primitive.div">
      <Container9 />
    </div>
  );
}
...
function PrimitiveDiv1() {
  return (
    <div className="bg-[#08f] col-1 content-stretch flex flex-col items-start ml-0 mt-[0.5px] overflow-clip pl-[-763.328px] pr-[763.328px] relative rounded-[16777200px] row-1 w-[213px]" data-name="Primitive.div">
      <Container10 />
    </div>
  );
}
...
function SlotClone() {
  return (
    <div className="absolute bg-white border border-[rgba(0,0,0,0.1)] border-solid h-[32px] left-0 rounded-[8px] top-0 w-[99.07px]" data-name="SlotClone">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[12.07px] not-italic text-[#0a0a0a] text-[14px] top-[5.5px] tracking-[-0.1504px]">View detail</p>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative rounded-[16px] shrink-0 w-[763px]" data-name="Container">
...
export default function Desktop() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex flex-col gap-[32px] items-center relative size-full" data-name="Desktop - 7">
      <GlobalHeader />
      <Frame />
    </div>
  );
