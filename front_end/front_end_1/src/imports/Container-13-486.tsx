import svgPaths from "./svg-wsmb2gbm7v";
...
function MootCourtSimulation1() {
  return (
    <div className="h-[48px] relative shrink-0 w-[622px]" data-name="MootCourtSimulation">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#0f172b] text-[16px] top-[-0.5px] tracking-[-0.3125px] w-[619px] whitespace-pre-wrap">xxxxxx</p>
      </div>
    </div>
  );
}
...
function Card1() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[73px] items-start left-0 pb-px pl-[25px] pr-px pt-[17px] rounded-[14px] top-[30px] w-[672px]" data-name="Card">
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[14px]" />
...
function Container2() {
  return (
    <div className="absolute h-[120px] left-[16px] top-[1081px] w-[672px]" data-name="Container">
      <Badge1 />
      <Card1 />
    </div>
  );
...
function Group1() {
  return (
    <div className="absolute contents left-[16px] top-[1081px]">
      <Container2 />
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[24px] relative shrink-0 w-[149px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#7b3306] text-[16px] top-[-0.5px] tracking-[-0.3125px] w-[159px] whitespace-pre-wrap">Defendant Objection</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex gap-[8px] items-start left-[calc(50%-31px)] top-[1052px] w-[180px]">
      <Icon1 />
      <Paragraph />
    </div>
  );
