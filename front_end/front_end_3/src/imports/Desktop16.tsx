import svgPaths from "./svg-872h0n3as2";
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[140.695px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#45556c] text-[16px] top-[-0.5px] tracking-[-0.3125px]">Judge’s Questioning Round</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="h-[24px] relative shrink-0 w-[107.906px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#62748e] text-[16px] top-[-0.5px] tracking-[-0.3125px] w-[108px] whitespace-pre-wrap">50% Complete</p>
      </div>
    </div>
  );
}
...
function PrimitiveDiv1() {
  return <div className="absolute bg-black h-[8px] left-0 rounded-[16777200px] top-0 w-[656px]" data-name="Primitive.div" />;
}
...
function Frame1() {
  return (
    <div className="absolute h-[1582px] left-0 top-[-296px] w-[896px]">
      <Group1 />
    </div>
  );
}
...
export default function Desktop() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex flex-col gap-[32px] items-center relative size-full" data-name="Desktop - 16">
      <GlobalHeader />
      <Container3 />
      <Container14 />
    </div>
